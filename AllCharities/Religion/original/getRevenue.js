...
var test3= [];
    ...
    var splitt = fs.readFileSync('allPages1.txt').toString();
...
fs.writeFileSync('rDonations.txt', test[zzz] +'\n',{flag:'a'});
fs.writeFileSync('nDonations.txt', test[zzz] +'\n',{flag:'a'});
fs.writeFileSync('tDonations.txt', test[zzz] +'\n',{flag:'a'});
